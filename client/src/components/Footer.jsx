...
export default function Footer() {
  return (
    <footer className="footer footer-center p-10 bg-blue-900 text-white">
      <aside className="flex items-center justify-between mb-6">
        <p className="font-bold">
          Take Care of Yourself and Be Happy <br/>feel free to reach out
        </p> 
        <nav>
      ...
      <p className="text-center"> © 2024 Satyam Kanojiya - All right reserved</p>
    </footer>
  );
}
